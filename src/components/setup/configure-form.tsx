            ...
            <div className="space-y-6">
                  ...
                  onTemplateChange={(templateId) => {
                    ...
                    if (
                      ...
                      if (pinacleConfig.services) {
                        setCustomServices(
                          pinacleConfig.services as ServiceId[],
                        );
                      }
                  ...
                  <>
                    ...
                    <div className="bg-white p-6 rounded-lg border-2 border-slate-200 space-y-4">
                      ...
                      <div className="space-y-4">
                        ...
                        {(form.watch("processes") || []).map(
                          (process, index) => (
                            <div
                              // biome-ignore lint/suspicious/noArrayIndexKey: meh
                              key={index}
                              className="p-4 bg-slate-50 rounded-lg border border-slate-200 space-y-3 relative"
                            >
              ...
              <div>
                ...
                <TierSelectorSetup
                  ...
                  minimumTier={
                    (selectedTemplate?.tier || "dev.small") as TierId
                  }
                />
              </div>
