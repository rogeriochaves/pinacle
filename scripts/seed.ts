...
const seedTemplates = [
  {
    ...
    description:
      "Full-stack React development with Next.js, TypeScript, and Tailwind CSS",
  ...
  },
  {
    ...
    description:
      "Python environment with Jupyter, pandas, numpy, and scikit-learn",
  ...
  },
  {
    ...
    description:
      "Node.js backend development with Express, TypeScript, and common tools",
